...
REPLACEMENTS = [
    ...
    ('FFFFFC06', 'Screen_state_word_0'),
    ('FFFFFC08', 'Screen_subcounter'),
    ('FFFFFC0C', 'Screen_data_ptr'),
    ('FFFFFC10', 'Menu_cursor'),
    ('FFFFFC12', 'Menu_substate'),
    ('FFFFFC14', 'Temp_x_pos'),
    ('FFFFFC16', 'Screen_state_word_1'),
    ('FFFFFC18', 'Temp_distance'),
    ('FFFFFC19', 'Screen_state_byte_0'),
    ('FFFFFC1A', 'Screen_state_byte_1'),
    ('FFFFFC1B', 'Screen_state_byte_2'),
    ('FFFFFC1C', 'Anim_delay'),
    ('FFFFFC1E', 'Team_select_state'),
